    ...
    <div className="grid grid-cols-2 gap-8 py-8 px-6 md:grid-cols-4">
        <div>
            ...
            <ul className="text-gray-500 dark:text-gray-400">
                <li className="mb-4">
                    <Link to='/' ame=" hover:underline">About</Link>
                </li>
                <li className="mb-4">
                    <Link to='/' ame="hover:underline">Careers</Link>
                </li>
                <li className="mb-4">
                    <Link to='/' ame="hover:underline">Brand Center</Link>
                </li>
                <li className="mb-4">
                    <Link to='/' ame="hover:underline">Blog</Link>
                </li>
            </ul>
        </div>
        <div>
            ...
            <ul className="text-gray-500 dark:text-gray-400">
                <li className="mb-4">
                    <Link to='/' ame="hover:underline">Discord Server</Link>
                </li>
                <li className="mb-4">
                    <Link to='/' ame="hover:underline">Twitter</Link>
                </li>
                <li className="mb-4">
                    <Link to='/' ame="hover:underline">Facebook</Link>
                </li>
                <li className="mb-4">
                    <Link to='/' ame="hover:underline">Contact Us</Link>
                </li>
            </ul>
        </div>
        <div>
            ...
            <ul className="text-gray-500 dark:text-gray-400">
                <li className="mb-4">
                    <Link to='/' ame="hover:underline">Privacy Policy</Link>
                </li>
                <li className="mb-4">
                    <Link to='/' ame="hover:underline">Licensing</Link>
                </li>
                <li className="mb-4">
                    <Link to='/' ame="hover:underline">Terms &amp; Conditions</Link>
                </li>
            </ul>
        </div>
        <div>
            ...
            <ul className="text-gray-500 dark:text-gray-400">
                <li className="mb-4">
                    <Link to='/' ame="hover:underline">iOS</Link>
                </li>
                <li className="mb-4">
                    <Link to='/' ame="hover:underline">Android</Link>
                </li>
                <li className="mb-4">
                    <Link to='/' ame="hover:underline">Windows</Link>
                </li>
                <li className="mb-4">
                    <Link to='/' ame="hover:underline">MacOS</Link>
                </li>
            </ul>
        </div>
    </div>
