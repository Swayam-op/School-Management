  ...
  return (
    <div className='py-12'>
        ...
        <div className='basis-2/3 z-50 w-full md:grow h-full flex flex-col justify-center box-border px-6 sm:px-12'>
            <h1 className='w-full text-4xl py-4'><span className='text-primary font-bold'>Total Concerntration In Library </span></h1>
            ...
            <div className="flex justify-center mb-4">
             <button className="inline-flex shadow-md shadow-gray-500 text-white bg-primary hover:bg-primary-text transition-all duration-400 text-lg py-2 px-5 rounded-sm">E-books To Refer</button>
              </div>
        </div>
